...
export default function CreateSemesterExamPage({
    params,
}: {
    ...
    const handleSubmit = async (e: React.FormEvent, publishNow?: boolean) => {
        ...
        try {
            const response = await fetch(`/api/admin/programs/${programId}/semesters/${semesterNumber}/exams`, {
                method: 'POST',
        ...
        <div className="min-h-screen bg-background">
            ...
            <div className="border-b bg-card">
                <div className="container mx-auto px-4 py-6">
                    <Link
                        href={`/admin/programs/${programId}/semesters/${semesterNumber}`}
                    ...
                    <p className="text-muted-foreground mt-1">এই সেমিস্টারের জন্য পরীক্ষা তৈরি করুন</p>
                </div>
            </div>
