...
export default function EditSemesterLessonPage({ params }: { params: Promise<PageParams> }) {
    const { programId, semesterNumber, lessonId } = use(params);
    ...
    const [attachments, setAttachments] = useState<Array<{ name: string; url: string; key?: string; type: string; _id?: string }>>([]);
    ...
    useEffect(() => {
        const fetchLesson = async () => {
            try {
                ...
                if (!response.ok) throw new Error('পাঠ লোড করতে সমস্যা হয়েছে');
                ...
                if (lesson.videoUrl) {
                    ...
                    setSourceType(isYoutube ? 'youtube' : (lesson.videoSource || 'r2'));
                    setVideoData({ url: lesson.videoUrl, key: lesson.videoKey });
                }
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (!response.ok) {
                throw new Error(data.error || 'পাঠ আপডেট করতে সমস্যা হয়েছে');
            }
            ...
            const errorMessage = error instanceof Error ? error.message : 'পাঠ আপডেট করতে সমস্যা হয়েছে';
        ...
        <div className="min-h-screen bg-background">
            <div className="container mx-auto px-4 py-8 max-w-4xl">
                ...
                <div className="mb-8">
                    ...
                    <h1 className="text-3xl font-bold">পাঠ এডিট করুন</h1>
                    <p className="text-muted-foreground mt-2">
                        পাঠের তথ্য ও বিষয়বস্তু পরিবর্তন করুন
                    </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="bg-card p-6 rounded-xl border">
                        <h2 className="text-lg font-semibold mb-4">বিষয়বস্তু *</h2>
                                    ...
                                    <div key={index} className="flex items-center justify-between p-3 bg-muted rounded-lg border">
                                        <div className="flex items-center gap-3 overflow-hidden">
                                            ...
                                            <div className="min-w-0">
                                                ...
                                                <p className="text-xs text-muted-foreground truncate w-48">{file.key || file.url}</p>
                                            </div>
                                        </div>
                                        <Button
                                            type="button"
                    ...
                    <div className="flex justify-end gap-3">
                        ...
                        <Button type="submit" disabled={saving || !videoData}>
                            {saving ? (
                                <>
