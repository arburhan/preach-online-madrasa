...
export default function NewLessonPage({
    ...
    params: Promise<{ programId: string; semesterId: string; sectionId: string }>
}) {
    const { programId, semesterId, sectionId } = use(params);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch(`/api/admin/programs/${programId}/semesters/${semesterId}/sections/${sectionId}/lessons`, {
                method: 'POST',
            ...
            <div className="container mx-auto px-4 py-8 max-w-4xl">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-muted-foreground mt-2">
                        আপনার সেমিস্টারে একটি নতুন ভিডিও বা ফাইল যোগ করুন
                    </p>
                </div>
