            ...
            <div className="container mx-auto px-4 py-8 max-w-6xl">
                ...
                <div className="bg-card p-6 rounded-xl border mb-8">
                    <div className="flex items-center justify-between mb-6">
                        ...
                        <div className='space-x-4'>
                            <Link href={`${basePath}/courses/${id}/exams/create`}>
                                <Button variant="outline">
                                    <FileText className="mr-2 h-4 w-4" />
                                    পরীক্ষা নিন
                                </Button>
                            </Link>
                            <Link href={`${basePath}/courses/${id}/lessons/new`}>
                                <Button>
                    ...
                    <LessonList lessons={serializedLessons} courseId={id} basePath={basePath} />
                </div>
                ...
                <div className="bg-card p-6 rounded-xl border">
                    ...
                    {serializedExams.length > 0 ? (
                        <ExamList exams={serializedExams} courseId={id} basePath={basePath} />
                    ) : (
